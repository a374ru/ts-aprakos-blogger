...
var OLY = (function () {
    function OLY(year) {
        var _a;
        this.year = year;
        this.theMomentTime = new Date(2099, 0, 25);
    ...
    OLY.prototype.initModalView = function () {
        ...
        var str = "\n        <section id=\"fp-content\" class=\"fp-content\">\n        <b>\u0421\u0435\u0434\u043C\u0438\u0446\u0430 \u0415\u0432\u0430\u043D\u0433\u0435\u043B\u0438\u044F: </b>\n        <div id=\"modal-cweek\">\u043F\u043E \u041F\u0430\u0441\u0445\u0435&nbsp; <span class=\"red bold\">".concat(this.anchorElemID, ",</span></div>\n        <div id=\"modal-cweek50\">\u043F\u043E \u041F\u044F\u0442\u044C&shy;\u0434\u0435\u0441\u044F\u0442&shy;\u043D\u0438\u0446\u0435 <span class=\"red bold\">").concat(this.weeks.current[0] > 7 ? Number(this.anchorElemID) - 7 : "нет", ".</span>\n        <div>").concat(lastSegment === "stvol.html" ? "".concat(this.weeks.stupkaV[1], " <span class=\"red bold\">").concat(Math.abs(this.weeks.stupkaV[0]), "</span> \u0441\u0435\u0434\u043C.") : "", "</div></div>\n        <div>").concat(lastSegment === "stvol.html" ? "".concat(this.weeks.stupkaK[1], " <span class=\"red bold\">").concat(Math.abs(this.weeks.stupkaK[0]), "</span> \u0441\u0435\u0434\u043C.") : "", "</div></div>\n        <div>").concat(lastSegment === "stvol.html" ? "".concat(this.weeks.all[1], " <span class=\"red bold\">").concat(Math.abs(this.weeks.all[0]), "</span> \u0441\u0435\u0434\u043C.") : "", "</div></div>\n        <div>").concat(lastSegment === "stvol.html" ? commentStvol : "", "</div></div>\n        <div>").concat(lastSegment === "blog-post.html" ? "".concat(this.weeks.stupkaK[1], " <span class=\"red bold\">").concat(Math.abs(this.weeks.stupkaK[0]), "</span> \u0441\u0435\u0434\u043C.") : "", "</div></div>\n        <div>").concat(lastSegment === "blog-page_13.html" ? "".concat(this.weeks.stupkaK[1], " <span class=\"red bold\">").concat(Math.abs(this.weeks.stupkaK[0]), "</span> \u0441\u0435\u0434\u043C.") : "", "</div></div>\n        ").concat(closeClick, "\n        </section>\n        ");
