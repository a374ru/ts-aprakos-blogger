...
Справка здесь: https://aprakos.blogspot.com/p/blog-page_4.html
	...
	initModalView() {
        ...
        <div id="modal-cweek">по Пасхе&nbsp; <span class="red bold">${
					this.anchorElemID
				},</span></div>
        <div id="modal-cweek50">по Пять&shy;десят&shy;нице <span class="red bold">${
	...
	// TODO #34 @a374ru функция обработки пользовательской даты и выводы на web-страницу вычисленных данных.
...
d:any = []
	/**
	 * Функция форматирует введённые пользователем время
	 */
